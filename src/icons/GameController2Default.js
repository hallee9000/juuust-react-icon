...
const GameController2Default = props => {
...
GameController2Default.propTypes = {
  color: PropTypes.string,
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number])
};

GameController2Default.defaultProps = {
  color: 'currentColor',
  size: '24'
};

export default GameController2Default;
