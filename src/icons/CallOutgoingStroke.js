  ...
  const CallOutgoingStroke = (props) => {
...
<path d="M20 4L15.5 8.5" stroke="currentcolor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M16 4H20V8" stroke="currentcolor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>

    )
  };

  CallOutgoingStroke.propTypes = {
  ...
  CallOutgoingStroke.defaultProps = {
    color: 'currentColor',
    size: '24',
  }

  export default CallOutgoingStroke
