...
const CloudDownloadDuotoneS = props => {
...
CloudDownloadDuotoneS.propTypes = {
  color: PropTypes.string,
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number])
};

CloudDownloadDuotoneS.defaultProps = {
  color: 'currentColor',
  size: '24'
};

export default CloudDownloadDuotoneS;
