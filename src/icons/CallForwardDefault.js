...
const CallForwardDefault = props => {
  ...
  return (
    ...
    >
      ...
      >
        <path
          d="M18.7425 13.8107C19.1877 13.922 19.5 14.322 19.5 14.7808V18.5001C19.5 19.0523 19.0517 19.5036 18.5007 19.4668C16.1413 19.3088 13.9744 18.5969 12 17.5001C9.75 16.2501 7.75 14.2501 6.5 12.0001C5.40312 10.0257 4.69124 7.85878 4.5333 5.49938C4.49641 4.94833 4.94772 4.50006 5.5 4.50006H9.21922C9.67809 4.50006 10.0781 4.81236 10.1894 5.25753L11 8.50006L9.25 10.5001C10 12.5001 11.5 14.0001 13.5 14.7501L15.5 13.0001L18.7425 13.8107Z"
          fill="#EBEFFF"
        />
        <path
          opacity="0.8"
