  ...
  const KeyboardDefault = (props) => {
    const { color, size, ...otherProps } = props;
    return (
      <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path opacity="0.8" d="M20 6H4C3.17157 6 2.5 6.67157 2.5 7.5V16.5C2.5 17.3284 3.17157 18 4 18H20C20.8284 18 21.5 17.3284 21.5 16.5V7.5C21.5 6.67157 20.8284 6 20 6Z" fill="#EBEFFF"/>
<path opacity="0.8" d="M20 6H4C3.17157 6 2.5 6.67157 2.5 7.5V16.5C2.5 17.3284 3.17157 18 4 18H20C20.8284 18 21.5 17.3284 21.5 16.5V7.5C21.5 6.67157 20.8284 6 20 6Z" stroke="#4400FF" stroke-width="1.5" stroke-linecap="round"/>
