  ...
  const CallIncomingeDuotoneF = (props) => {
...
<path opacity="0.8" d="M15.5 8.5L20 4" stroke="#34D399" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
<path opacity="0.8" d="M19.5 8.5H15.5V4.5" stroke="#34D399" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
  ...
  CallIncomingeDuotoneF.propTypes = {
  ...
  CallIncomingeDuotoneF.defaultProps = {
    color: 'currentColor',
    size: '24',
  }

  export default CallIncomingeDuotoneF
