  ...
  return (
    ...
    >
      ...
      >
        <path
          opacity="0.8"
          d="M12.5502 19.9603L8 14.5H4V4.5H17.8604C18.8138 4.5 19.6346 5.17292 19.8216 6.10777L20.7823 10.9117C21.1536 12.768 19.7337 14.5 17.8406 14.5H14.5L15.2089 18.7534C15.3613 19.6677 14.6562 20.5 13.7293 20.5H13.7026C13.2574 20.5 12.8352 20.3023 12.5502 19.9603Z"
          fill="#EBEFFF"
        />
        <path
          opacity="0.8"
