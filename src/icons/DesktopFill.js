...
const DesktopFill = props => {
  ...
  return (
    ...
    >
      ...
      >
        <path
          d="M9.5 19.5C9.5 19.2239 9.72386 19 10 19H14C14.2761 19 14.5 19.2239 14.5 19.5C14.5 19.7761 14.2761 20 14 20H10C9.72386 20 9.5 19.7761 9.5 19.5Z"
          fill="#0A0A0B"
        />
