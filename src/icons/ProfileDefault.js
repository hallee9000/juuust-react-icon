    ...
    >
      ...
      >
        <path
          ...
          fill-rule="evenodd"
          clip-rule="evenodd"
          d="M15.25 7.7449C15.25 9.54082 13.7931 11 12 11C10.2069 11 8.75 9.55102 8.75 7.7551C8.75 5.95918 10.2069 4.5 12 4.5C13.7931 4.5 15.25 5.94898 15.25 7.7449ZM20 18C20 18 17.25 20 12 20C6.75 20 4 18 4 18C5 15.75 8.25 14 12 14C15.75 14 19 15.75 20 18Z"
          fill="#EBEFFF"
        />
        <path
          opacity="0.8"
