  ...
  const CallMissedDuotoneS = (props) => {
...
<path opacity="0.8" d="M15.5 4L20 8.5" stroke="#34D399" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>

    )
  };

  CallMissedDuotoneS.propTypes = {
  ...
  CallMissedDuotoneS.defaultProps = {
    color: 'currentColor',
    size: '24',
  }

  export default CallMissedDuotoneS
