  ...
  return (
    ...
    >
      ...
      >
        <path
          opacity="0.8"
          d="M3.5 6C3.5 5.44772 3.94772 5 4.5 5H19.5C20.0523 5 20.5 5.44772 20.5 6V17.5C20.5 18.0523 20.0523 18.5 19.5 18.5H4.5C3.94772 18.5 3.5 18.0523 3.5 17.5V6Z"
          fill="#EBEFFF"
        />
        <path
          opacity="0.8"
