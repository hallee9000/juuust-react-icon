...
<circle cx="17.75" cy="6.25" r="3" fill="currentcolor"/>
</svg>

    )
  };

  CallAvailableFill.propTypes = {
  ...
  CallAvailableFill.defaultProps = {
    color: 'currentColor',
    size: '24',
  }

  export default CallAvailableFill
