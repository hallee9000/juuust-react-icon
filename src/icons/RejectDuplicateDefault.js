    ...
    >
      ...
      >
        <path
          fill-rule="evenodd"
          clip-rule="evenodd"
          d="M19 20C19.5523 20 20 19.5523 20 19V10.5C20 9.94772 19.5523 9.5 19 9.5H14.5V5C14.5 4.44772 14.0523 4 13.5 4H5C4.44772 4 4 4.44771 4 5V13.5C4 14.0523 4.44771 14.5 5 14.5H9.5V19C9.5 19.5523 9.94771 20 10.5 20H19Z"
          fill="#EBEFFF"
        />
        <path
          opacity="0.8"
