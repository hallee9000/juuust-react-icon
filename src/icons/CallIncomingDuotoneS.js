  ...
  const CallIncomingDuotoneS = (props) => {
...
<path opacity="0.8" d="M15.5 8.5L20 4" stroke="#34D399" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
<path opacity="0.8" d="M19.5 8.5H15.5V4.5" stroke="#34D399" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
  ...
  CallIncomingDuotoneS.propTypes = {
  ...
  CallIncomingDuotoneS.defaultProps = {
    color: 'currentColor',
    size: '24',
  }

  export default CallIncomingDuotoneS
